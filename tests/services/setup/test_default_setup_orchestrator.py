...
def create_workspace_context() -> WorkspaceContext:
    ...
    return WorkspaceContext(
        ...
        project_file=Path(
            "C:\\Projetos\\Projeto\\Projeto.csproj"
        ),
    )
...
def create_paths() -> SetupPaths:
    ...
    return SetupPaths(
        publish_path=Path(
            "C:\\Projetos\\Projeto\\bin\\Release\\publish"
        ),
        setup_output_path=Path(
            "C:\\Installers"
        ),
        output_msi=Path(
            "C:\\Installers\\Teste.msi"
        ),
        aip_path=Path(
            "C:\\Projetos\\Projeto\\Setup\\Teste.aip"
        ),
        visualstudio_setup_path=None,
    )
...
def create_definition(
    ...
    return SetupDefinition(
        ...
        platform="AnyCPU",
        solution_path=Path(
            "C:\\Projetos\\Projeto\\Projeto.sln"
        ),
...
def test_deve_retornar_falha_quando_workspace_nao_puder_ser_resolvido():
    ...
    workspace_resolver.resolve.side_effect = ValueError(
        "Workspace inválido."
    )
...
def test_deve_retornar_falha_quando_setup_path_nao_puder_ser_resolvido():
    ...
    setup_path_resolver.resolve.side_effect = ValueError(
        "Caminhos do Setup inválidos."
    )
